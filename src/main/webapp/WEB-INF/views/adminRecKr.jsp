...
<body>
   ...
   <div class="container-fluid text-center">
      <div class="row content">
         <div class="form-group col-md-12 col-lg-12 text-left" style="margin-left:50px;">
            <h1>For Recruiter</h1>
            <form id="modify" name="modify" action="recQKrMod" method="post">
               <%
                  List<RecQKr> dtos = (List<RecQKr>) request.getAttribute("recqkr");
                  List<RecQEn> dtos2 = (List<RecQEn>) request.getAttribute("recqen");
                  int cnt = (Integer) request.getAttribute("cntrecqkr");
                  RecQKr dto = null;
                  RecQEn dto2 = null;
               %>
               <p>
                  <button type="button"
                     ...
                     style="color: white;" id="addDefault">A Type</button>
                  <button type="button"
                     class="w3-btn w3-teal w3-border w3-round-large"
                     style="color: white;" id="addText">B Type</button>
                     <button type="button"
                     class="w3-btn w3-purple w3-border w3-round-large"
                     style="color: white;" id="addC">C Type</button>
               <p>
                               ...
                               if (ind < 16) {
                                  var div = "<div class='form-group-default' id='TextBoxContainer"+ind+"'>";
                                     div += "<label for='radios_"+ind+"'>Q"+ (ind+nullcnt)
                                           + "&nbsp;KR&nbsp;&nbsp;</label><input style = 'width:800px;' name = 'recqKr"+(ind+nullcnt)+"' type='text' value = '' /><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>EN</b>&nbsp;&nbsp;<input style = 'width:800px;' name = 'recqEn"+(ind+nullcnt)+"' type='text' value = ''  />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
                                           + "<input type='hidden' name='recqType" + (ind+nullcnt) + "' value='A'>"    
                           ...
                           $("#addText").bind("click", function() {
                              ...
                              if (ind < 16) {
                                 var div = "<div class='form-group-text' id='TextBoxContainer"+ind+"'>";
                                    div += "<label for='radios_"+ind+"'>Q"+ (ind+nullcnt)
                                          + "&nbsp;KR&nbsp;&nbsp;</label><input style = 'width:800px;' name = 'recqKr"+(ind+nullcnt)+"' type='text' value = '' /><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>EN</b>&nbsp;&nbsp;<input style='width: 800px;' name = 'recqEn"+(ind+nullcnt)+"' type='text' value = '' />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
                                          + "<input type='hidden' name='recqType" + (ind+nullcnt) + "' value='B'>"
                           ...
                           $("#addC").bind("click", function() {
                               ...
                               if (ind < 16) {
                                  var div = "<div class='form-group-text' id='TextBoxContainer"+ind+"'>";
                                     div += "<label for='radios_"+ind+"'>Q"+ (ind+nullcnt)
                                           + "&nbsp;KR&nbsp;&nbsp;</label><input style = 'width:800px;' name = 'recqKr"+(ind+nullcnt)+"' type='text' value = '' /><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>EN</b>&nbsp;&nbsp;<input style='width: 800px;' name = 'recqEn"+(ind+nullcnt)+"' type='text' value = '' />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
                                           + "<input type='hidden' name='recqType" + (ind+nullcnt) + "' value='C'>"
               ...
               <div class="form-group" id="total">
                  <%
                     for (int i = 0; i < cnt; i++) {
                        ...
                        if(i<9){
                  %>
                  <div class="form-group" id="TextBoxContainer<%=dto.getRecQNum()%>"
                     style="position: left;">
                     <!-- Multiple Radios (inline) -->
                     <label for="radios_<%=dto.getRecQNum()%>">Q<%=dto.getRecQNum()%></label>&nbsp;&nbsp;
                     <b>KR</b>&nbsp;&nbsp;<input name="recqKr<%=dto.getRecQNum()%>" type="text"
                        value="<%=dto.getRecQKr()%>" style="width: 800px;"><br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>EN</b>&nbsp;&nbsp;<input
                        name="recqEn<%=dto2.getRecQNum()%>" type="text"
                        value="<%=dto2.getRecQEn()%>" style="width: 800px;">
                     &nbsp;&nbsp;&nbsp;&nbsp; <input type="hidden"
                        name="recqType<%=dto.getRecQNum()%>"
                        value="<%=dto.getRecQType()%>">
                     <%
                        if (dto.getRecQType().equals("A")) {
                     %>
                     <button type="button"
                        class="w3-btn w3-pink w3-border w3-round-large" id="rm"
                        onclick="delSrvy(<%=dto.getRecQNum()%>)">Remove</button>
                     <%
                     ...
                     <button type="button"
                        ...
                        onclick="delSrvy(<%=dto.getRecQNum()%>)">Remove</button>
                     <%
                        } else if (dto.getRecQType().equals("C")) {
                            %>
                            <button type="button"
               ...
               <button type="submit"
                  onclick='document.getElementById("recqkrcnt").value = ind + nullcnt;window.open("./askMoreMod", "Saved Successfully","width=150", "height=160", "resizable=yes", "scrollbars=no", "status=yes");'
